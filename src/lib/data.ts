        ...
        byFeature: [
          {
            ...
            ok: 1,
            error: 0,
            lastCalledAt: new Date(Date.now() - 36 * 60 * 1000).toISOString(),
            lastUsedModel: 'Qwen/Qwen2.5-7B-Instruct',
            lastErrorCode: null,
          ...
          },
          {
            ...
            ok: 2,
            error: 0,
            lastCalledAt: new Date(Date.now() - 18 * 60 * 1000).toISOString(),
            lastUsedModel: 'deepseek-chat',
            lastErrorCode: null,
            lastErrorMessage: null,
          },
          {
            featureId: 'generate_html',
            total: 1,
            ok: 1,
            error: 0,
            lastCalledAt: new Date(Date.now() - 12 * 60 * 1000).toISOString(),
            lastUsedModel: 'vision-demo-model',
            lastErrorCode: null,
            lastErrorMessage: null,
          },
          {
            featureId: 'health_check',
            total: 1,
            ok: 1,
            error: 0,
        ...
        recentFailures: [
          {
            ...
            errorMessage: '当前模型响应过慢，建议换用更快模型或系统默认模型。',
